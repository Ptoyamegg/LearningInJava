...
//                    language = "sisc";
                ...
                final String frameClassName = args.length < 2 ? "xyz.dyk.buttons1.ButtonFrame" : args[1];
    ...
    /**
     * Gather all named components in a container
     *
    ...
    /**
     * Adds a listener too an object whose listener method executes a script.
     *
